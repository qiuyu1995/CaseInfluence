...
CaseInfluence_nonsmooth <- function(a, B, c, lam, alpha_0, alpha_1, beta_0_w0, beta_w0, theta_w0, model_class, influence_measure) {
    .Call(`_CaseInfluence_CaseInfluence_nonsmooth`, a, B, c, lam, alpha_0, alpha_1, beta_0_w0, beta_w0, theta_w0, model_class, influence_measure)
}
...
LocalInfluence_nonsmooth <- function(a, B, c, lam, alpha_0, alpha_1, beta_0_w0, beta_w0, theta_w0, model_class, influence_measure) {
    .Call(`_CaseInfluence_LocalInfluence_nonsmooth`, a, B, c, lam, alpha_0, alpha_1, beta_0_w0, beta_w0, theta_w0, model_class, influence_measure)
}
...
CaseInfluence_logistic <- function(X, Y, theta_0, t_max, lam, epsilon, method, influence_measure) {
    .Call(`_CaseInfluence_CaseInfluence_logistic`, X, Y, theta_0, t_max, lam, epsilon, method, influence_measure)
}
...
LocalInfluence_logistic <- function(X, Y, theta_0, lam, influence_measure) {
    .Call(`_CaseInfluence_LocalInfluence_logistic`, X, Y, theta_0, lam, influence_measure)
}
...
CaseInfluence_poisson <- function(X, Y, theta_0, t_max, lam, epsilon, method) {
    .Call(`_CaseInfluence_CaseInfluence_poisson`, X, Y, theta_0, t_max, lam, epsilon, method)
}
...
LocalInfluence_poisson <- function(X, Y, theta_0, lam) {
    .Call(`_CaseInfluence_LocalInfluence_poisson`, X, Y, theta_0, lam)
}
